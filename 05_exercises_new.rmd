...
racing_train<-small_trains %>% 
  ...
  labs(title = "month mean delay time of stations",
...
tomato_dailyweight<-garden_harvest %>% 
  ...
  ggplot(aes(y=cum_pound,
             x=date,
             fill=fct_reorder(variety,desc(daily_harvest_lb))))+
  geom_area()+
...
mallorca_map <- get_stamenmap(
    ...
    zoom = 10)
ggmap(mallorca_map)+
  annotate(geom = "text", x = 3, y = 39.6, label = "Current Position", col="red")+
  annotate(geom="point",x = 3, y = 39.61,col="red")
```
